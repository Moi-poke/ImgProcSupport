...
class GuiApp:
    def __init__(self, master=None):
        ...
        self.sbTh.configure(
            from_=0, increment=0.01, textvariable=self._threshold, to=1, width=5
        )
        ...
        self.entryCount.configure(
            takefocus=False, textvariable=self.matchCount, width=75
        )
        ...
        self.labelAccuracy.configure(text="Accuracy", textvariable=self.TVAccuracy)
        ...
        self.labelCoodinate.configure(text="Coodinate", textvariable=self.TVCoodinate)
        ...
        self.entryCoodinate.configure(textvariable=self.matchCoodinate, width=75)
        ...
        self.openSetting.configure(text="Setting", textvariable=self.TVopenSetting)
        ...
        self.getLatest.configure(text="Get Latest Image", textvariable=self.TVgetLatest)
        ...
        self.saveSelectArea.configure(
            text="Save Select Area", textvariable=self.TVsaveSelectArea
        )
        ...
        self.loadFrame.grid(column=0, columnspan=2, pady=5, row=0, sticky="nsew")
        ...
        self.loadTemplate.configure(
            text="Load Template Image", textvariable=self.TVloadTemplate, width=50
        )
        ...
        self.labelTempSize.configure(
            text="Template is not set", textvariable=self.TVlabelTempSize
        )
        ...
        self.generatedCommand = tk.StringVar(value="Command will be shown here")
        self.entryCommandShow.configure(
            justify="left", takefocus=False, textvariable=self.generatedCommand
        )
...
class initSetting:
    def __init__(self, master=None):
        ...
        self.labelLanguage.configure(text="Language", textvariable=self.TVlanguage)
